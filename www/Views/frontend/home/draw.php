                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 mt-5">
                            <div class="card-block mx-5">
                                <h5 class="m-b-20 p-b-5 b-b-default f-w-600 border-bottom mb-4">Rút tiền</h5>
                                <div class="row mb-5 mr-4">
                                    
                                    <!-- form -->
                                    <form class="mx-1 mx-md-4" action="/index.php?controller=home&action=drawcheck" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class=" form-group form-outline flex-fill mb-0 ">
                                            ...
                                            <textarea id="note" class="form-control border" name="note" rows="3"></textarea>
                                        </div>
                                        </div>

                                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                        <button type="submit" name='submitregister' class="btn btn-primary btn-lg">Rút tiền ngay</button>
                                        </div>
