                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 mt-5">
                            <div class="card-block mx-5">
                                <h6 class="m-b-20 p-b-5 b-b-default f-w-600 border-bottom mb-4">Thông tin nạp tiền</h6>
                                <div class="row mb-5">
                                    <div class="col-sm-6">
                                        <p class="m-b-10 f-w-600">Mã giao dịch</p>
                                        <p class="m-b-10 f-w-600">Trạng thái</p>
                                        <p class="m-b-10 f-w-600">Phí giao dịch</p>
                                        <p class="m-b-10 f-w-600">Số tiền</p>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <p class="m-b-10 text-muted f-w-400">0 đ</p>
