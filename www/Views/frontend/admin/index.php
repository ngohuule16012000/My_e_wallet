...
?>
                    ...
                    <td>
                        ...
                        if($value['status'] === 'chờ xác minh') {
                            echo '<span class="badge badge-warning rounded-pill d-inline text-dark">' . $value['status'] . '</span>';
                        }
                        else if($value['status'] === 'đã xác minh')
                        {
                            echo '<span class="badge badge-success rounded-pill d-inline text-dark">' . $value['status'] . '</span>';
                        }
                        else
                        {
                            echo '<span class="badge badge-danger rounded-pill d-inline text-dark">' . $value['status'] . '</span>';
                        } ?>
                        </div>
                    </td>
