...
?>
                    ...
                    <td>
                        <div class="mt-2">
                            <span class="badge badge-primary rounded-pill d-inline text-danger"><?= $value['status'] ?></span>
                        </div>
                    </td>
                    <td>
                        <p class="fw-normal mt-2"><?= date("d-m-Y H:i:s", strtotime($value['lockedtime'])) ?></p>
                    </td>
                    <td>
